...
- (void)viewDidLoad {
    ...
    studyBook = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height - 144) collectionViewLayout:layout];
...
//    cell.backgroundColor = [UIColor colorWithRed:((10 * indexPath.row) / 255.0) green:((20 * indexPath.row)/255.0) blue:((30 * indexPath.row)/255.0) alpha:1.0f]; 
    ...
    if ([MBProgressHUD findDocumentsFile:[[musicArr objectAtIndex:[indexPath row]] valueForKey:@"filePath"]])
    { 
        [tui setBackgroundImage:[UIImage imageNamed:@"暂停.png"] forState:UIControlStateNormal];
    }
    else
    {
...
- (void)SwitchClick:(UIButton *)btn
{
    ...
    NSLog(@"customAlertView.tag = %d",customAlertView.tag);
