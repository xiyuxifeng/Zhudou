...
//    self.tabedSlideView.viewControllers = @[ctrl1, ctrl2, ctrl3];
    ...
    DLTabedbarItem *item1 = [DLTabedbarItem itemWithTitle:@"免费资源" image:nil selectedImage:nil];
    DLTabedbarItem *item2 = [DLTabedbarItem itemWithTitle:@"竹兜专属" image:nil selectedImage:nil];
    DLTabedbarItem *item3 = [DLTabedbarItem itemWithTitle:@"父母用书" image:nil selectedImage:nil];
